...
- Added typed domain document models, validation, MongoDB persistence adapters, and CQRS command/query modules with a local orchestrator.
...
- Added unit tests for validation and the CQRS orchestrator plus integration-test scaffolding behind the `integration` build tag.
